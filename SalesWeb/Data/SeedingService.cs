...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Beatrice", "beatrice@gmail.com", new DateTime(1986, 10, 5), 1000.0, d1);
            Seller s2 = new Seller(2, "Frederica Bernkastel", "frederica@gmail.com", new DateTime(1992, 2, 15), 3500.0, d2);
            Seller s3 = new Seller(3, "Eva Beatrice", "eva@gmail.com", new DateTime(1999, 1, 20), 2200.0, d1);
            Seller s4 = new Seller(4, "Kyrie Sumadera", "kyrie@gmail.com", new DateTime(1995, 8, 16), 3000.0, d4);
            Seller s5 = new Seller(5, "Battler Ushiromiya", "battler@gmail.com", new DateTime(1986, 10, 6), 5000.0, d3);
            Seller s6 = new Seller(6, "Furudo Erika", "erika@gmail.com", new DateTime(1992, 8, 15), 4000.0, d2);
